...
export QRL_ASSET_ROOT="${QRL_ASSET_ROOT:-${QRL_ENV_ROOT}/../qrl-assets}"
export D4RL_DATASET_DIR="${D4RL_DATASET_DIR:-${QRL_ASSET_ROOT}/d4rl/datasets}"
export MUJOCO_PY_MUJOCO_PATH="${MUJOCO_PY_MUJOCO_PATH:-${QRL_ASSET_ROOT}/mujoco/mujoco210}"
export MUJOCO_PATH="${MUJOCO_PATH:-${MUJOCO_PY_MUJOCO_PATH}}"
